...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Call FileUploadScreen activity
        startActivity(new Intent(MainActivity.this, FileUploadScreen.class));

        // Finish MainActivity so that it's not added to the back stack
        finish();
    }
